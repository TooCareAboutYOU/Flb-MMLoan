...
public class HttpModule {
    ...
    Retrofit provideDhfRetrofit(Retrofit.Builder builder, OkHttpClient client) {
        return createRetrofit(builder, client, BaseConfig.getInstance().getBaseUrl()); // BaseApiService.HOST
    }


    @Singleton
    @Provides
    BaseApiService provideLoanMainService(@LoanMainUrl Retrofit retrofit) {
    ...
    OkHttpClient provideClient(OkHttpClient.Builder builder) {
        ...
        if (BuildConfig.DEBUG) {
            HttpLoggingInterceptor mHttpLoggingInterceptor = new HttpLoggingInterceptor(message -> Log.w("PRETTY_LOGGER", "--->>" + message.toString()));

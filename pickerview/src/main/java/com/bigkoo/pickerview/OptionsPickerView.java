...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void setPicker(List<T> optionsItems, WheelOptions.OnItemScrollListener onItemScrollListener) {
        wheelOptions.setPicker(optionsItems,onItemScrollListener);
        SetCurrentItems();
    }

...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items, final OnItemScrollListener onItemScrollListener) {
        ...
        wv_option1.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                onItemScrollListener.OnItemScrollSelect(index);
            }
        });
    }
    ...
    public interface OnItemScrollListener {
        void OnItemScrollSelect(int options1);
    }

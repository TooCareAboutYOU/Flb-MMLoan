...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Context context) {
        ...
        mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.mis_dp_72);
    }
        ...
        if (holder != null) {
            if (i == 0) {
                ...
                if (mFolders.size() > 0) {
                    ...
                    if (f != null) {
                        Glide.with(mContext).load(new File(f.cover.path))
                                .apply(new RequestOptions()
                                .error(R.drawable.mis_default_error)
                                .override(R.dimen.mis_dp_72, R.dimen.mis_dp_72)
                                .centerCrop())
                                .into(holder.cover);
                    }else{

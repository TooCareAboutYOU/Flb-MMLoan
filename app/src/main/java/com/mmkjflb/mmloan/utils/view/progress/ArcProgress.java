package com.mmkjflb.mmloan.utils.view.progress;
...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        min_size = (int) DensityUtil.dp2px(getResources(), 100);
        default_text_size = DensityUtil.sp2px(getResources(), 40);
        default_suffix_text_size = DensityUtil.sp2px(getResources(), 15);
        default_suffix_padding = DensityUtil.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = DensityUtil.sp2px(getResources(), 10);
        default_stroke_width = DensityUtil.dp2px(getResources(), 4);

...
public class VerificationCodeView extends View {
    ...
    //白背景颜色
    private int WHITE_BG_COLOR = Color.WHITE;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            isWrapContent = true;
            mWidth = (int) (textPaint.measureText("0") * 1.5 * codeNum + 20 + DensityUtil.dp2px(getContext().getResources(), 8));
        }
        if (heightMode == MeasureSpec.EXACTLY) {
            // Parent has told us how big to be. So be it.
            mHeight = heightSize;
        } else {//没有设置高度，先默认显示40dp
            mHeight = (int) DensityUtil.dp2px(getContext().getResources(), 40);
        }
    ...
    private void initView() {
        ...
        bgPaint.setColor(WHITE_BG_COLOR);
        ...
        maxTextSize = DensityUtil.sp2px(getContext().getResources(), 40);
        defaultTextSize = DensityUtil.sp2px(getContext().getResources(), 30);
        textPaint = new Paint();
    ...
    private void createCodeBitmap() {
        ...
        if (!isWrapContent) {
            ...
            horizontalOffset = (int) ((mWidth - drawWidth - DensityUtil.dp2px(getContext().getResources(), 8)) / 2);
        ...
        //画背景
        myCanvas.drawColor(WHITE_BG_COLOR);
    ...
    private void dynamicSetTextPaint(String text) {
        int avaiWidth = (int) (mWidth * 2.0f / 3 - getPaddingLeft() - getPaddingRight() - DensityUtil.dp2px(getContext().getResources(), 2));
        if (avaiWidth <= 0) {
            return;
        }

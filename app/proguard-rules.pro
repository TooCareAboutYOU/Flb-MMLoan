...
#
-dontwarn com.mmkjflb.mmloan.model.**
#对含有反射类的处理
-keep class com.mmkjflb.mmloan.model.** { *; }
-keep class com.mmkjflb.mmloan.utils.** {*;}
-dontwarn com.mmkj.baselibrary.model.**
#对含有反射类的处理
-keep class com.mmkj.baselibrary.model.** { *; }
-keep class com.mmkj.baselibrary.util.** {*;}
# ----------------------------- 其他的 -----------------------------
#
# 删除代码中Log相关的代码
